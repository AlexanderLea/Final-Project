...
printf("Hello - I am the parent process. I am about to fork() and make a child (no
giggling please)\n");
...
system("sudo timeout 1 hcitool lescan");
system("sudo gatttool -b C4:4F:B7:B1:41:D7 --char-write-req --handle=0x000f --value=0100 --listen");
}
else
{
//PARENT PROCESS
int status; //I shall store the status info about the child in this
integer
